package com.expense.moneytracker.viewmodels;
...
//                .findAll();
    ...
    public void addTransaction() {
        ...
        realm.copyToRealmOrUpdate(new Transaction(Constants.INCOME,"Rent","Others", "Some note here",new Date(),500,new Date().getTime()));
